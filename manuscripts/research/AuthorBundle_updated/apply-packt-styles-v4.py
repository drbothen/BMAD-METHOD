#!/usr/bin/env python3
"""
Apply PacktPub [PACKT] Styles to Pandoc-Converted Word Documents v4

FIXED: Correctly distinguishes bullet lists from numbered lists by checking numFmt attribute
...
Usage:
    python3 apply-packt-styles-v4.py input.docx output.docx
"""
...
def main():
    if len(sys.argv) < 3:
        print("Usage: python3 apply-packt-styles-v4.py input.docx output.docx")
    ...
    print("PacktPub Style Application Tool v4")
    print("=" * 70 + "\n")
