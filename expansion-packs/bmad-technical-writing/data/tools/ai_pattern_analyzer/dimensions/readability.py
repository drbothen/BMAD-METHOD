...
class ReadabilityDimension(DimensionStrategy):
    ...
    def calculate_score(self, metrics: Dict[str, Any]) -> float:
        """
        Calculate 0-100 score based on Flesch Reading Ease (primary metric).

        AI clusters around 60-70 (standard mid-range).
        Extreme values indicate AI signature.

        Algorithm:
        - Flesch < 30 or > 90 = 25 score (Too extreme - AI signature)
        - Flesch < 40 or > 80 = 50 score (Borderline extreme)
        - Flesch 60-70 = 62.5 score (Standard range - neutral)
        - Otherwise = 100 score (Natural variation - human-like)

        Research observations:
        - Human: Natural variation across full range (30-90)
        - AI: Clusters in 60-70 range or produces extremes
        ...
        # AI clusters around 60-70 (standard) or produces extremes
        if flesch < 30 or flesch > 90:
            score = 25.0  # Too extreme - AI signature
        elif flesch < 40 or flesch > 80:
            score = 50.0  # Borderline extreme
        elif 60 <= flesch <= 70:
            score = 62.5  # Standard range - neutral (not necessarily AI, but common)
        else:
            score = 100.0  # Natural variation - human-like
