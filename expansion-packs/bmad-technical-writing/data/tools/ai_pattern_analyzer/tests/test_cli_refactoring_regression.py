...
from ai_pattern_analyzer.cli.main import main, create_analysis_config, show_dry_run_config
...
class TestDryRunFunctionality:
    ...
    def test_dry_run_single_file(self, sample_markdown_file):
        ...
        runner = CliRunner()
        result = runner.invoke(main, [sample_markdown_file, '--dry-run'])
    ...
    def test_dry_run_batch(self, sample_batch_dir):
        ...
        runner = CliRunner()
        result = runner.invoke(main, ['--batch', sample_batch_dir, '--dry-run'])
    ...
    def test_dry_run_with_mode_fast(self, sample_markdown_file):
        ...
        runner = CliRunner()
        result = runner.invoke(main, [sample_markdown_file, '--mode', 'fast', '--dry-run'])
...
class TestModeParameters:
    ...
    def test_mode_adaptive_accepted(self, sample_markdown_file):
        ...
        runner = CliRunner()
        result = runner.invoke(main, [sample_markdown_file, '--mode', 'adaptive', '--dry-run'])
        assert result.exit_code == 0

    def test_mode_sampling_accepted(self, sample_markdown_file):
        """Test SAMPLING mode is accepted."""
        runner = CliRunner()
        result = runner.invoke(main, [sample_markdown_file, '--mode', 'sampling', '--dry-run'])
        assert result.exit_code == 0

    def test_mode_full_accepted(self, sample_markdown_file):
        """Test FULL mode is accepted."""
        runner = CliRunner()
        result = runner.invoke(main, [sample_markdown_file, '--mode', 'full', '--dry-run'])
        assert result.exit_code == 0
...
class TestHelpAndInformation:
    ...
    def test_help_modes_flag(self):
        ...
        result = runner.invoke(main, ['--help-modes'])
...
class TestErrorHandling:
    ...
    def test_no_file_or_batch_error(self):
        ...
        runner = CliRunner()
        result = runner.invoke(main, ['--mode', 'fast'])
    ...
    def test_invalid_mode_error(self, sample_markdown_file):
        ...
        runner = CliRunner()
        result = runner.invoke(main, [sample_markdown_file, '--mode', 'invalid'])
    ...
    def test_invalid_samples_range_low_error(self, sample_markdown_file):
        ...
        runner = CliRunner()
        result = runner.invoke(main, [sample_markdown_file, '--samples', '0'])
    ...
    def test_invalid_samples_range_high_error(self, sample_markdown_file):
        ...
        runner = CliRunner()
        result = runner.invoke(main, [sample_markdown_file, '--samples', '25'])
    ...
    def test_nonexistent_file_error(self):
        ...
        runner = CliRunner()
        result = runner.invoke(main, ['nonexistent_file.md'])
