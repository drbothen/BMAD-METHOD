...
DIMENSION_MODULE_MAP = {
    'perplexity': 'ai_pattern_analyzer.dimensions.perplexity',
    'burstiness': 'ai_pattern_analyzer.dimensions.burstiness',
    'structure': 'ai_pattern_analyzer.dimensions.structure',
    'formatting': 'ai_pattern_analyzer.dimensions.formatting',
    'voice': 'ai_pattern_analyzer.dimensions.voice',
    'readability': 'ai_pattern_analyzer.dimensions.readability',
    'lexical': 'ai_pattern_analyzer.dimensions.lexical',
    'sentiment': 'ai_pattern_analyzer.dimensions.sentiment',
    'syntactic': 'ai_pattern_analyzer.dimensions.syntactic',
    'predictability': 'ai_pattern_analyzer.dimensions.predictability',
    'advanced_lexical': 'ai_pattern_analyzer.dimensions.advanced_lexical',
    'transition_marker': 'ai_pattern_analyzer.dimensions.transition_marker',
}
...
BUILTIN_DIMENSION_PROFILES = {
    ...
    'full': list(DIMENSION_MODULE_MAP.keys()),  # 12 dims, ~4-6s (ML dependencies)
}
