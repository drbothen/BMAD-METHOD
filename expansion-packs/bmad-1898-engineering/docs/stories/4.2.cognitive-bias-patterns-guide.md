...
## Tasks / Subtasks
- [ ] Create cognitive bias patterns guide (AC: 1, 2, 3, 4)
  - [ ] Create `data/cognitive-bias-patterns.md`
  - [ ] Document all 5 bias types
  - [ ] Provide security-specific examples
  - [ ] Include debiasing strategies
  - [ ] Add self-assessment questions
- [ ] Document Confirmation Bias (AC: 1, 2, 3)
  - [ ] Definition and psychology
  - [ ] Security analysis examples
  - [ ] Impact on vulnerability assessment
  - [ ] Debiasing techniques
- [ ] Document Anchoring Bias (AC: 1, 2, 3)
  - [ ] Definition and psychology
  - [ ] CVSS anchoring examples
  - [ ] Impact on priority assessment
  - [ ] Debiasing techniques
- [ ] Document Availability Heuristic (AC: 1, 2, 3)
  - [ ] Definition and psychology
  - [ ] Recent breach influence examples
  - [ ] Impact on risk perception
  - [ ] Debiasing techniques
- [ ] Document Overconfidence Bias (AC: 1, 2, 3)
  - [ ] Definition and psychology
  - [ ] Certainty without evidence examples
  - [ ] Impact on analysis quality
  - [ ] Debiasing techniques
- [ ] Document Recency Bias (AC: 1, 2, 3)
  - [ ] Definition and psychology
  - [ ] New CVE over-prioritization examples
  - [ ] Impact on resource allocation
  - [ ] Debiasing techniques
- [ ] Create self-assessment guide (AC: 4)
  - [ ] Questions to detect personal bias patterns
  - [ ] Scoring system
...
**Test Cases:**
1. New analyst reads guide: Can they identify biases in example scenarios?
2. Self-assessment: Does scoring correlate with actual bias in enrichments?
3. Debiasing techniques: Do analysts apply them successfully?
4. Long-term: Do bias detection rates improve after training?
