...
## Tasks / Subtasks
- [ ] Create priority framework documentation (AC: 1, 2, 3, 4)
  - [ ] Create `data/priority-framework.md`
  - [ ] Define P1-P5 levels with criteria
  - [ ] Document factor weighting
  - [ ] Specify SLA timelines
  - [ ] Document priority modifiers
- [ ] Define P1 - Critical (AC: 1, 3)
  - [ ] Criteria: CVSS + EPSS + KEV + ACR + Exposure combinations
  - [ ] Examples
  - [ ] SLA: 24 hours
  - [ ] Actions required
- [ ] Define P2 - High (AC: 1, 3)
  - [ ] Criteria
  - [ ] Examples
  - [ ] SLA: 7 days
  - [ ] Actions required
- [ ] Define P3 - Medium (AC: 1, 3)
  - [ ] Criteria
  - [ ] Examples
  - [ ] SLA: 30 days
  - [ ] Actions required
- [ ] Define P4 - Low (AC: 1, 3)
  - [ ] Criteria
  - [ ] Examples
  - [ ] SLA: 90 days
  - [ ] Actions required
- [ ] Define P5 - Informational (AC: 1, 3)
  - [ ] Criteria
  - [ ] Examples
  - [ ] SLA: No SLA
  - [ ] Actions required
- [ ] Document factor weighting (AC: 2)
  - [ ] CVSS weight
  - [ ] EPSS weight
  - [ ] KEV weight
  - [ ] ACR weight
  - [ ] System Exposure weight
  - [ ] Exploit Availability weight
- [ ] Document priority modifiers (AC: 4)
  - [ ] Automatic elevation rules
  - [ ] Priority reduction rules
