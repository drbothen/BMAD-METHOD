...
**My Recommendation:** Option A - Reclassify and clarify. The guide should be accurate to MITRE's categorization while providing context that remote service exploits can be initial access *vectors* but the *technique* T1210 specifically models lateral movement behavior.
