...
test_category: poor_link_quality
violations:
  - Excessive meaningless links (link spam)
  - Random associations without context
  - Broken link quality
---
...
- Related Concepts Test: PASS (just links, no in-depth explanation)
- Building Block Test: PASS (concept type)
- Completeness Test: PASS (complete explanation)
- Independence Test: PASS (self-contained)
- Link Quality Test: FAIL (critical failure - 30+ random links without meaningful relationships or context)
- Metadata Test: PASS
- Expected score: 0.4-0.5 (NON-ATOMIC - link spam degrades quality)
- Suggested remediation: Remove random links, keep only 3-5 directly related concepts with semantic relationships
